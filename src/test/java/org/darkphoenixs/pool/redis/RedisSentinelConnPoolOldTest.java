...
public class RedisSentinelConnPoolOldTest {
    ...
    public void test_0() throws Exception {
        ...
        try {
            RedisSentinelConnPoolOld pool = new RedisSentinelConnPoolOld("localhost",
                    new HashSet<String>(
        ...
        try {
            RedisSentinelConnPoolOld pool = new RedisSentinelConnPoolOld(
    ...
    public void test_1() throws Exception {
        ...
        try {
            ...
            pool.initPool(new PoolConfig(), new RedisConnectionFactoryOld(
